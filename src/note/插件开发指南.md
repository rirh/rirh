...
```json
{
  ...
  "homepage": "https://github.com/rirh/h-xtool",
  "repository": {
    "type": "git",
    "url": "git+https://github.com/rirh/h-xtool.git"
  },
  "license": "MIT",
  "files": ["dist"],
  "main": "dist/index.cjs",
...
当前的 hello-lib 项目已发布到 npmjs ，可以查看该包的主页 [@h-xtool/lib](https://www.npmjs.com/package/@h-xtool/lib) ，也可以通过 npm 安装到项目里使用了：
